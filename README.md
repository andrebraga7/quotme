...
Quotme is a platform developed to give users the ability to share and discover new quotes. Users can create an account, share quotes, like and save quotes and follow user to see relevant content from followers.
Each user has a profile page that gives them the ability of writing a personal statement, adding a profile picture.
The quote page allows users to comment and share their thoughts about a quote. Users can also reply to individual comments, this allows users to carry out a conversation.
The authors page displays the top ten most popular authors by the number of quotes. When an user clicks on an author he is taken to the author page where he can view and search all quotes from that author.
